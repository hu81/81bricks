...
public interface BrkSetMapper 
{
    ...
    public int batchBrkSetCategory(List<BrkSetCategory> list);

    public int deleteBrkSetCategoryBySetId(Long setId);
    ...
    public int deleteBrkSetMeshBySetId(Long setId);
}
